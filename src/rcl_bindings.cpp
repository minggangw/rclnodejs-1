...
Napi::Value RclTake(const Napi::CallbackInfo& info) {
  ...
  void* msg_taken = info[1].As<Napi::Buffer<void>>().Data();
...
Napi::Value RclTakeResponse(const Napi::CallbackInfo& info) {
  ...
  void* taken_response = info[1].As<Napi::Buffer<void>>().Data();
...
Napi::Value RclTakeRequest(const Napi::CallbackInfo& info) {
  ...
  void* taken_request = info[2].As<Napi::Buffer<void>>().Data();
...
Napi::Value InitString(const Napi::CallbackInfo& info) {
  ...
  void* buffer = info[0].As<Napi::Buffer<void>>().Data();
#if ROS_VERSION >= 2006
